...
def compute_OI_2d(lon,lat,U,loni,lati,lx,ly,ang,eps,T_mean) :
    ...
    decorrelation scales lx and ly. 
              ...
              lon=longitude of the stations 1d array --> np.flatten() (in deg)
              lat=latitude of the stations  1d array --> np.flatten() (in deg)
              loni=new longitude points  1d array --> only lon points! (in deg)
              lati=new latitude points   1d array --> only lat points! (in deg)
              lx=decorrelation scale in x-direction (in km)
              ly=decorrelation scale in y-direction (in km)
